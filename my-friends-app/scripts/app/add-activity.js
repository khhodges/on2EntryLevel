...
app.addActivity = (function () {
    ...
    var addActivityViewModel = (function () {
        ...
        var pickImage = function () {
            function success(imageURI) {
                ...
                app.helper.convertToDataURL(selected, function (base64Img) {
					baseImage = base64Img;},"image/jpeg")
        ...
        var saveActivity = function () {
			...
			if(selected === undefined || !baseImage){app.showAlert("First take a photo with your camera and then add a message to match!","Informational");}
