...
var appSettings = {
    ...
    LINES: '<div class="iw-title"></div>'
                  + '<div class="iw-content"><div class="iw-subTitle">%Name%</div>'
                  + '<div><a data-role="button" class="butn" data-rel="external" href="tel:#:Phone#">'
                  + '<img src="styles/images/phone2.png" alt="phone" height="auto" width="12%"></a><br /> <small>#:Address#, </small><i>#:Message#</i>, #:Phone#, #:Email#, <b>#:Open #</b>, #:Review#, #:Stars#, #:Distance#, #:Cost#<p>',
    START: '<div >LINES',
