...
var appSettings = {
	...
	END: '</div>',
	HEAD: '<div><div class="iw-subTitle">%Name%</div>' + '<div><a data-role="button" class="butn" data-rel="external" href="tel:Phone">' + '<img src="styles/images/phone2.png" alt="phone" height="auto" width="25%" style="padding:5px"></a><small>' + 'Address, Open Stars</small></div>' + '<div ><br/><a data-role="button" class="butn" href="components/activities/view.html?partner=%Name%"><img src="styles/images/on2see-icon-120x120.png" alt="On2See" height="auto" width="25%" style="padding:5px"></a>' + '<a data-role="button" class="butn" href="UrlString"><img src="styles/images/thumb_up.png" alt="On2See" height="auto" width="25%" style="padding:5px"></a>' + '<a data-role="button" class="butn" href="components/notifications/view.html?partner=%Name%");"><img src="styles/images/green-share.png" alt="On2See" height="auto" width="25%" style="padding:5px"></a>' + '<a data-role="button" class="butn" onclick="test(\'https://www.google.com/maps/place/Google\');"><img src="styles/images/googleMap.png" alt="Google" height="auto" width="25%" style="padding:5px"></a>' + '<a data-role="button" class="butn" data-rel="external" onclick="test(\'https://twitter.com/search?q=Twitter\');"><img src="styles/images/twitter.png" alt="Twitter" height="auto" width="25%" style="padding:5px"></a>' + '<a id="cameraLink" ><img src="styles/images/instagram.png" alt="Camera" height="auto" width="25%" style="padding:5px"></a>' + '<a data-role="button" class="butn" data-rel="external" onclick="test(\'https://www.facebook.com/Facebook\');"><img src="styles/images/facebook2.png" alt="Facebook" height="auto" width="25%" style="padding:5px"></a>' + '<a data-role="button" class="butn" data-rel="external" onclick="test(\'WebSite\')"><img src="Icon" alt="Logo" height="auto" width="25%" style="padding:5px"></a>' + '</div>',
