...
var appSettings = {
	...
	spanish:{
	    ...
	    continueAnonomously:"Va a continuar sin las caracteristicas de la cámara de la POST de la comunidad ...",
	    ...
	    infoWindow:"Esta ventana de la investigacion Social Media es la medida para este lugar, haga clic en cualquier icono para cavar más profundo!",
	    ...
	    membership:"Ahora está agregado a CloudClub de esta pareja!",
	    ...
	    registerOption:"Si registrarse y acceder todas las características de la POST comunidad están disponibles ...",
	    register:"El registro permite el acceso a la contabilizacion de la cámara y otras características de la comunidad y notificacion.",
	    registeredOK:"Se ha registrado capaz de ello para las notificaciones locales.",
	    registration:"Felicidades! Ya está registrado para utilizar CloudClub",
        ...
        saved:"Artículo salvo",
        savedAvatar:"Actualizacion de guarda, se necesita tiempo para almacenar en caché la nueva imagen a través de Internet!",
        searchAgain:"Siempre se puede buscar en el mapa de la zona expuesta por una ciudad o por 20 surgestions cualquier plazo, como la comida, la pizza, la policía, la iglesia o la escuela!",
        sent:"Mensaje enviado ... ",
        share:"Opciones sobre acciones ahora cargar …",
        signIn:"Por Favor regístrese...",
        tryAgain:"Por favor, inténtelo de nuevo ...",
        update:"Actualizacion exitosa",
        updating:"Carga de artículos, por favor espere ...",
